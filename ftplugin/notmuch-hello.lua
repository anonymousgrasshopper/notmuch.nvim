...
vim.keymap.set("n", "<CR>", function() nm.search_terms("tag:" .. vim.fn.getline('.')) end, { buffer = true })
vim.keymap.set("n", "c", function() vim.notify(nm.count("tag:" .. vim.fn.getline('.'))) end, { buffer = true })
